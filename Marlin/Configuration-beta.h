...
#define PIDTEMP
#define PID_MAX 50 // limits current to nozzle; 255=full current
#ifdef PIDTEMP
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 1600, 123}  // default steps per unit for ultimaker 
